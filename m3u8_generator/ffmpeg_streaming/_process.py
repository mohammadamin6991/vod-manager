...
from ._hls_helper import HLSKeyInfoFile
from ._utiles import get_time, time_left

#Me
from ._utiles import get_speed
...
class Process(object):
    ...
    def __init__(self, media, commands: str, monitor: callable = None, monitor_args=None, **options):
        """
        @TODO: add documentation
        """
    ...
    def _monitor(self):
        ...
        while True:
            ...
            if callable(self.monitor):
                ...
                # Me
                speed = get_speed(line, speed)
                _time = get_time('time=', line, _time)
                self.monitor(line, duration, _time, time_left(start_time, _time, duration), self.process, self.monitor_args, speed=speed)
